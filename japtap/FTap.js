...
mvyv();
	...
	$("button#transc").on("click", function(event){show(0); });
	/*$("button.bre").on("click", function(event){ out(); });
	$("button.bpp").on("click", function(event){ pmr(2); })*/
	$("button#good").on("click", function(event){ pmr(1); });
	$("button#bad").on("click", function(event){ pmr(-1); });
	$("button#neutral").on("click", function(event){ pmr(0.5); });
